...
const String ssid = "1724";                                 //The name of the Wi-Fi network you are connecting to
const String pass = "toledorockets";                             //Your WiFi network password
const long myChannelNumber = 1598863;                            //Your Thingspeak channel number
const char * myWriteAPIKey = "PBHR1QBGEF6ZE12F";                 //Your ThingSpeak Write API Key
//------------------------------------------------------------------
